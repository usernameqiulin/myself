    ...
    (0, _createClass3.default)(Route, [{
        ...
        value: function createRenderResult(props, context, state) {
            ...
            if (state.match) {
                ...
                if (_react.Component.isPrototypeOf(component) || component.prototype instanceof _react.Component) {
                    this.setState({
                        renderResult: _react2.default.createElement(component, renderProps)
                    });
                } else {
                    var tryAsyncComponent = component(renderProps);
                    // if(tryAsyncComponent instanceof Promise){
                    if ("[object Promise]" === Object.prototype.toString.call(tryAsyncComponent)
                    // 对特殊情况做特性判断，需要再想想有没有更好的方式
                    || (typeof tryAsyncComponent === "undefined" ? "undefined" : (0, _typeof3.default)(tryAsyncComponent)) === "object" && typeof tryAsyncComponent.then === "function") {
                        // 对异步路由组件做缓存
                        // 防止layout切换的时候，renderResult来回切换，不能进行组件复用，造成缓存数据丢失
                        if (this.AsyncComponent) {
                            this.setState({
                                renderResult: _react2.default.createElement(this.AsyncComponent, renderProps)
                            });
                            return;
                        }
                        ...
                        tryAsyncComponent.then(function (component) {
                            if (!_this2.isUnmount) {
                                ...
                                _this2.AsyncComponent = component;
...
Route.contextTypes = _reactRouter.Route.contextTypes;
