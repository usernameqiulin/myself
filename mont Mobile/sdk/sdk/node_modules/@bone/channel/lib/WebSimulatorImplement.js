...
var ChannelWebBridge = function () {
    ...
    _createClass(ChannelWebBridge, [{
        ...
        value: function ready(_ref2, callback) {
            ...
            var _mqttOptions = this.mqttOptions,
                clientId = _mqttOptions.clientId,
                mqttClientId = _mqttOptions.mqttClientId,
                mqttUsername = _mqttOptions.mqttUsername,
                mqttPassword = _mqttOptions.mqttPassword,
                topicRoot = _mqttOptions.topicRoot;

            var topicPrefix = topicRoot;
            ...
            var validProps = ['clientId', 'mqttClientId', 'mqttUsername', 'mqttPassword', 'topicRoot'];
...
var ClientWrapper = function () {
    ...
    _createClass(ClientWrapper, [{
        ...
        value: function _onMessageArrived(rawMsg) {
            ...
            var topic = rawMsg.destinationName.replace(/^\/sys\/[^\/]+\/[^\/]+\/app\/down/, '');
            var msg = { topic: topic };
            try {
        ...
        value: function _onMessageDelivered(msg) {
            ...
            var topic = DELIVER_PREFIX + msg.destinationName.replace(/^\/sys\/[^\/]+\/[^\/]+\/app\/up/, '');
            this.emit(topic, msg);
        }
    }, {
        key: '_onConnected',
